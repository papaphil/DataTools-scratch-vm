...
//#region pls hide this
    ...
    */
    ...
    /**
     * Generates an array of blocks to be displayed to the user
     * by excluding any hidden files (files generated by a data function)
     * @returns {Array} Blocks to be displayed
     */
    generateDisplayedBlocks() {
        let blocks = [];
        Object.keys(this._files).forEach(file => {
...
//#endregion
    ...
    /**
     * Generic handler for data functions, uses the 
     * FUNCTION parameter to choose
     * @param {Object} args The block's argument
     * @param {Object} util Block Utility object provided by the runtime
     */
    ...
    /**
     * Saves a given function to a new name, primarily used
     * to save mapped data sets that are otherwise hidden
     * @param {Object} args The block's arguments
     * @param {Object} util Block Utility object provided by the runtime
